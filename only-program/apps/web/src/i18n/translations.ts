  ...
  es: {
    ...
    dashboard: {
      ...
      links: {
        ...
        borderColor: "Color de Borde (Avatar)",
        borderDesc: "Aplica al borde del perfil en Plantilla Minimal",
        opacity: "Opacidad",
  ...
  en: {
    ...
    dashboard: {
      ...
      links: {
        ...
        borderColor: "Border Color (Avatar)",
        borderDesc: "Applies to profile border in Minimal Template",
        opacity: "Opacity",
        buyLinks: "Buy Links",
  ...
  fr: {
    ...
    dashboard: {
      ...
      links: {
        ...
        borderColor: "Couleur Bordure (Avatar)",
        borderDesc: "S'applique à la bordure du profil dans le modèle Minimal",
        opacity: "Opacité",
