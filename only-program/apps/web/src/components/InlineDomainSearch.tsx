...
const InlineDomainSearch = ({ onDomainSelected, initialValue = '' }: InlineDomainSearchProps) => {
        ...
        <div className="mt-4 animate-fade-in relative z-10">
            <div className="relative">
                <input
                    ...
                    className={`w-full bg-black/40 border rounded-xl pl-10 pr-10 py-3 text-white focus:outline-none transition-colors text-sm font-bold
            ...
            <div className="mt-2 text-xs font-medium h-4">
                {loading && <span className="text-silver/50">Verificando disponibilidad...</span>}
